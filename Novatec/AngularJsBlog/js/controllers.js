	...
	function BlogCtrl ($scope) {
		$scope.blogList = [
			...
			},
			{
				"_id" : 2,
				"date" : 1400267723107,
				"introText" : "In the blog post we will learn how to build applications based on REST",
				"blogText" : "In the blog post we will learn how to build applications based on REST web services that contain most of the business logic needed for the application."
			}
		]
	}
]);
...
blogControllers.controller('BlogViewCtrl', ['$scope', '$routeParams', 
	function BlogViewCtrl ($scope, $routeParams) {
		...
		var blog2 = {
			...
			"comments" : [
				{
					"commentText" : "REST is great. I want to kwon more."
				},
				{
